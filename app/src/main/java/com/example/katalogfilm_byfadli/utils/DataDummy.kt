...
object DataDummy {
    ...
    fun loadTvShowsData(): List<TvShowItem> {
        return listOf(
            TvShowItem(
                backdropPath = "/pNCZbQ5jvCbgoBfeoSx0l5dJhIM.jpg",
                firstAirDate = "2021-11-28",
                genreIds = listOf(
                    18,
                    9648,
                    10765
                ...
                id = 135864,
                name = "Elves",
                overview = "The Christmas vacation of a teenage girl and her family turns into a nightmare when they discover the ancient threat that haunts the island where they are.",
                posterPath = "/6upMMT2Uz4bhJabBCWhYKESIbF4.jpg",
                voteAverage = 7.0,
                voteCount = 111
            ),
            TvShowItem(
            ...
            TvShowItem(
                backdropPath = "/rPxpLKsIWAolP7jFM1RjY4QL8K.jpg",
